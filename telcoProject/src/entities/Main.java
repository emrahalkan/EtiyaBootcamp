...
import entities.concretes.AdslProduct;
...
public class Main {
	public static void main(String[] args) {
		...
		CorporateCustomer corporateCustomer1 = new CorporateCustomer("123", "ABC", 1, "12345278278", subscriptions,
				addresses);
		Address address1 = new Address(1, "İzmir", addressType1, corporateCustomer1);
		Service service1 = new Service(1, "Telefon", products, subscriptions);
		AdslProduct adslProduct1 = new AdslProduct(1, "ASUS", "13456", "BakÄ±r", "1", service1, 5, 2);
		Subscription subscription1 = new Subscription(1, corporateCustomer1, LocalDate.parse("2022-01-01"), service1,
				subscriptionPackages, invoices);
		products.add(adslProduct1);
		Package package1 = new Package(1, "Paket", 100, LocalDate.parse("2022-01-01"), LocalDate.parse("2022-02-02"),
				30, subscriptionPackages);
		Canal channel1 = new Canal(1, "Kanal", payments);
		SubscriptionPackage subscriptionPackage1 = new SubscriptionPackage(1515, subscription1, package1);

		IndividualCustomer individualCustomer1 = new IndividualCustomer(2, "789456", "Atakan", "sfsdknfsd", "5468948",
