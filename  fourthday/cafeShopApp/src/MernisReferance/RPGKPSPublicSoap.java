...
public class RPGKPSPublicSoap
{
    ...
    public RPGKPSPublicSoap(){}

    public RPGKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public RPGKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        RPGExtendedSoapSerializationEnvelope envelope= new RPGExtendedSoapSerializationEnvelope(RPGExtendedSoapSerializationEnvelope.VER11);
