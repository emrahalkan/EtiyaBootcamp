...
public class GQCKPSPublicSoap
{
    ...
    public GQCKPSPublicSoap(){}

    public GQCKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public GQCKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        GQCExtendedSoapSerializationEnvelope envelope= new GQCExtendedSoapSerializationEnvelope(GQCExtendedSoapSerializationEnvelope.VER11);
